...
export function GET(request: NextRequest) {
  ...
  const configUrl = new URL("/api/widgets/interactive-custom-cursor/config", request.url);
...
function getEmbedScript(configUrl: string) {
  ...
  function normalize(config) {
    var defaults = {
      ...
      linkStyle: { enabled: false, cursorType: 'dot-ring', cursorSize: 38, borderWidth: 2, hoverColor: '#087a46', hoverText: 'OPEN' },
